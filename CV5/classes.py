...
# Modified configuration class for Differential evolution
class DEConfiguration(Configuration):
    def __init__(self, range_min: float, range_max: float, point_spacing: float, function: float, surface_x: float, surface_y: float, surface_z: float, surface_z_min: float):
...
class PlotLine:
    def __init__(self, data):
        ...
        pyplot.title('Differential evolution progress (lower is better)')
